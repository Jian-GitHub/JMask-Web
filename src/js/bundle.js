...
(() => {
        ...
        635: (t, e, r) => {
            ...
            function i(t, e) {
                ...
                return "string" == typeof t && "" !== t.trim() && t.split(";").forEach((function (t) {
                    var o = t.split(":");
                    if (2 === o.length) if (o[0].indexOf(",") > -1) o[0].split(",").forEach((function (t) {
                        r[t.trim()] = o[1].trim()
                    })); else if (o[0].indexOf("...") > -1) for (var i = n(o[0].split("...").map((function (t) {
                        return +t
                    })).sort((function (t, e) {
                        return t - e
                    })), 2), u = i[0], a = i[1], c = u; c <= a;) c = Number(c.toFixed((null == e ? void 0 : e.decimals) || 2)), r[c] = o[1].trim(), c += (null == e ? void 0 : e.increment) || .01; else r[o[0].trim()] = o[1].trim()
                })), r
            }
            ...
            function i(t, e, r, n) {
                var o = 1e-6, i = 3 * t - 3 * r + 1, u = 3 * r - 6 * t, a = 3 * t, c = 3 * e - 3 * n + 1,
                    l = 3 * n - 6 * e, s = 3 * e;
            ...
            function a(t, e) {
                if ("string" == typeof t) e = u[t](e); else {
                    var r = n(t, 4);
    ...
    (() => {
        ...
        r.r(n);
        var t = r(381);
        var e = ["tg-follow", "tg-ref"], o = {}, i = r(523);
        ...
        function u(r, n, i) {
            ...
            var c = function (t, r, n) {
                ...
                return t
            }(r, n, u), l = c.hasAttribute(n) ? c.getAttribute(n) : null;
            return o[u].get(l, i)
        }
        ...
        function c(e) {
            var r, n = (0, t.G)(), o = u(e, "".concat(n, "follow")) || e, i = getComputedStyle(o),
                a = +i.getPropertyValue("--".concat(n, "top")), c = +i.getPropertyValue("--".concat(n, "height")),
                l = u(e, "".concat(n, "name")), s = u(o, "".concat(n, "from")), f = u(o, "".concat(n, "to")),
                d = u(o, "".concat(n, "steps")), m = u(o, "".concat(n, "step")), g = u(o, "".concat(n, "bezier")),
                p = u(e, "".concat(n, "filter")), v = u(o, "".concat(n, "edge")), y = Math.abs(f - s),
                b = 0 === m ? y / d : m, h = y / b,
                w = (r = b, Math.floor(r) === r ? 0 : r.toString().split(".")[1].length || 0), A = s > f ? -1 : 1;
            return {
                el: e,
                top: a,
                height: c,
        ...
        function l(t) {
            var e = document.documentElement, r = e.scrollTop, n = e.clientHeight;
            t.forEach((function (t) {
                var e = t.el, o = t.top, i = t.height, u = t.increment, c = t.segments, l = t.decimals,
                    s = t.multiplier, f = t.name, d = t.from, m = t.mapping, g = t.filter, p = t.edge, v = t.lastValue,
                    y = t.bezier;
                if ("--_" !== f) {
                    var b,
                        h = "cover" === p ? Math.min(Math.max((r + n - o) / (n + i), 0), 1) : Math.min(Math.max((r - o) / (i - n), 0), 1);
        ...
        function f(e, r) {
            ...
            document.querySelectorAll("[".concat(n, "name]")).forEach((function (t) {
                var r = t.getBoundingClientRect(), o = r.top, i = r.height;
